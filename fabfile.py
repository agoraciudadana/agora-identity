"""
Starter fabfile for deploying the agora_identity project.
...
# CHANGEME
env.hosts = ['user@agora_identity.example.com']
env.code_dir = '/srv/www/agora_identity'
env.project_dir = '/srv/www/agora_identity/agora_identity'
env.static_root = '/srv/www/agora_identity/static/'
env.virtualenv = '/srv/www/agora_identity/.virtualenv'
env.code_repo = 'git@github.com:user/agora_identity.git'
env.django_settings_module = 'agora_identity.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/agora_identity/wsgi.py" % env.code_dir)
