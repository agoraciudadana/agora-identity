...
ROOT_URLCONF = 'agora_identity.urls'
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': "agora_identity.settings.base.custom_show_toolbar",
...
WSGI_APPLICATION = 'agora_identity.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[agora_identity]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_agora_identity"  # Make this unique to your project.
